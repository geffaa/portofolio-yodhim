...
const personalDataset: { [key: string]: DatasetEntry } = {
  greetings: {
    ...
    responses: [
      "Hi there! I'm Yodhim's AI assistant. Feel free to ask me anything about his skills, projects, or experiences!",
      "Hello! I'm here to share information about Yodhim. What would you like to know?",
      "Welcome! I'm an AI trained to answer questions about Yodhim. How can I assist you today?",
      "Greetings! I'd be happy to tell you all about Yodhim. What aspect of his professional life interests you?"
    ]
  },
  skills: {
    patterns: ['skill', 'able to', 'capable', 'proficient', 'expertise', 'technology', 'tech stack', 'programming languages', 'frameworks'],
    responses: [
      "Yodhim is proficient in full-stack development, with expertise in React, Node.js, and Python. He's also skilled in AI and machine learning.",
      "As a developer, Yodhim excels in both front-end and back-end technologies. He's particularly strong in creating responsive web applications and implementing complex algorithms.",
      "Yodhim's technical skills include web development, mobile app creation, and data analysis. He's always eager to learn and apply new technologies to solve problems.",
      "In terms of programming languages, Yodhim is fluent in JavaScript, TypeScript, Python, and Java. He's also familiar with C++ and Rust for systems programming.",
      "Yodhim's expertise extends to cloud technologies like AWS and Azure, as well as containerization with Docker and Kubernetes."
    ]
  },
  projects: {
    patterns: ['project', 'portfolio', 'work', 'developed', 'created', 'built', 'application', 'software'],
    responses: [
      "One of Yodhim's recent projects was an AI-powered financial analysis tool. He used React for the front-end and TensorFlow.js for the AI components.",
      ...
      "A notable project in Yodhim's portfolio is an e-learning platform with adaptive learning features. He built it using Next.js for the frontend and Node.js for the backend.",
      ...
      "One of Yodhim's passion projects is an open-source library for data visualization, which has gained popularity in the developer community."
    ]
  },
  experience: {
    patterns: ['experience', 'background', 'history', 'career', 'professional', 'work history', 'job', 'position'],
    responses: [
      "Yodhim has 5 years of professional experience in software development. He's worked with startups and established tech companies on various challenging projects.",
      ...
      "Yodhim's experience spans from developing enterprise-level applications to creating innovative solutions for small businesses. He's adaptable to different project scales and requirements.",
  ...
  education: {
    ...
    responses: [
      ...
      "Yodhim's educational background also includes a minor in Business Administration, giving him insights into the business aspects of software development."
    ]
  },
  interests: {
  ...
  workPhilosophy: {
    ...
    responses: [
      ...
      "Collaboration and knowledge sharing are key aspects of Yodhim's work philosophy. He enjoys working in diverse teams and believes in the power of collective problem-solving.",
  ...
  availability: {
    ...
    responses: [
      ...
      "Yodhim is available for both full-time positions and freelance projects. He's particularly interested in roles that challenge him to grow and innovate.",
      "While Yodhim is open to remote work, he's also willing to relocate for the right opportunity that aligns with his career goals.",
  ...
  achievements: {
    ...
    responses: [
      ...
      "Yodhim's article on 'The Future of AI in Web Development' was featured in a prominent tech magazine last year.",
      ...
      "One of Yodhim's machine learning projects was selected for presentation at an international AI conference, marking a significant achievement in his career."
    ]
  },
  strengths: {
    patterns: ['strength', 'strong point', 'forte', 'excel', 'best at', 'specialize'],
    responses: [
      "Yodhim's greatest strength is his ability to bridge the gap between complex technical concepts and practical, user-friendly solutions.",
      ...
      "One of Yodhim's key strengths is his ability to communicate technical concepts clearly to both technical and non-technical stakeholders.",
      "Yodhim's strength lies in his holistic approach to development, considering not just the code, but also user experience, scalability, and long-term maintenance."
    ]
  },
  futureGoals: {
    ...
    responses: [
      ...
      "One of Yodhim's main goals is to contribute to the field of ethical AI, ensuring that AI technologies are developed and used responsibly.",
      ...
      "Yodhim's long-term goal is to found a tech startup that focuses on using AI and web technologies to address global environmental challenges."
    ]
  },
  default: {
    patterns: [],
    responses: [
      "That's an interesting question about Yodhim! While I don't have specific information on that, I'd be happy to tell you about his skills or projects instead.",
      "Great query! I'm not sure about that specific detail, but I can share information about Yodhim's work experience or technical skills if you're interested.",
      "Hmm, I don't have that particular information about Yodhim. But I'd be glad to talk about his recent projects or his approach to software development. What would you like to know?",
      "While I don't have an exact answer for that, I can tell you about Yodhim's educational background or his future career goals. Would either of those interest you?",
      "That's a unique question! Although I don't have that specific information, I could share some of Yodhim's notable achievements or his work philosophy. Which would you prefer?"
    ]
  }
};
...
const PersonalAIChatbot: React.FC = () => {
  const [messages, setMessages] = useState<Message[]>([
    { role: 'assistant', content: "Hello! I'm Yodhim's AI assistant. I'm here to answer your questions about Yodhim's skills, projects, experiences, and more. What would you like to know about him?" }
  ]);
      ...
      if (isDefault) {
        setTimeout(() => {
          setMessages(prev => [...prev, { 
            role: 'assistant', 
            content: "If you're not sure what to ask, you can inquire about Yodhim's skills, recent projects, work experience, or educational background. Feel free to ask anything!" 
          }]);
        }, 1000);
      }
    ...
    <div className="bg-[#112240] rounded-lg shadow-md overflow-hidden h-[500px] flex flex-col z-50 relative">
      <div className="bg-[#1D3461] p-4">
        <h3 className="text-[#64FFDA] font-semibold flex items-center">
          <Bot className="w-5 h-5 mr-2" /> Yodhim's Personal AI Assistant
        </h3>
      </div>
