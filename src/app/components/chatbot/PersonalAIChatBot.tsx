...
const personalDataset = {
  ...
  hobbies: [
    "When not coding, Yodhim enjoys outdoor photography. He finds it a great way to balance his tech-focused work life.",
    "Yodhim is an avid reader of science fiction and tech novels. He believes this fuels his creativity in problem-solving.",
    "To stay active, Yodhim practices yoga and goes hiking. He finds these activities help him maintain a clear mind for coding challenges."
  ],
  achievements: [
...
const PersonalAIChatbot: React.FC = () => {
  const [messages, setMessages] = useState<Message[]>([
    { role: 'assistant', content: "Hello! Im Yodhim AI assistant. Im here to answer your questions about Yodhim skills, projects, experiences, and more. What would you like to know about him?" }
  ]);
      ...
      if (isDefault) {
        setTimeout(() => {
          setMessages(prev => [...prev, { 
            role: 'assistant', 
            content: "If your not sure what to ask, you can inquire about Yodhim skills, recent projects, work experience, or educational background. Feel free to ask anything!" 
          }]);
        }, 1000);
      }
