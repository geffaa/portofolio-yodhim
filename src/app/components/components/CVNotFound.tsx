  ...
  return (
    <div className="relative w-full h-screen bg-gray-900 overflow-hidden">
      ...
      <div className="relative z-10 h-full flex flex-col items-center justify-center text-white p-4">
        ...
        >
          <span className="absolute top-0 left-0 -ml-1 sm:-ml-2 text-red-500 opacity-70 animate-glitch-1">Eitss</span>
          <span className="absolute top-0 left-0 -ml-0.5 sm:-ml-1 text-blue-500 opacity-70 animate-glitch-2">Eitss</span>
          Eitss
        </motion.div>
        <motion.div
        ...
        >
          {"Untuk CV bisa minta secara pribadi ya".split("").map((char, index) => (
